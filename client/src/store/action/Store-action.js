...
export const addStore=(dataAdd)=>{
  return dispatch =>{
    ...
    axios.post(baseUrlStore,{store_name,store_address},{
      headers:{
...
export const editStore=(dataEdit)=>{
  return dispatch =>{
    ...
    axios.patch(baseUrlStore+'/'+id,{store_name,store_address},{
      headers:{
        access_token:localStorage.getItem('access_token')
      }
    })
...
export const deleteStore=(dataDelete)=>{
  return dispatch =>{
    axios.delete(baseUrlStore+'/'+dataDelete.id,{
      headers:{
        access_token:localStorage.getItem('access_token')
      }
    })
